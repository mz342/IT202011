...
<form method = "POST">
  <a style= "margin: 1em; float: right;" type="submit" class="btn btn-danger" href="checkout.php" name="checkout">checkout</a>
</form>
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      <td><a href = "test_view_products.php?id=<?php safer_echo($r['product_id']); ?>"> <?php safer_echo($r["name"])?></a></td>
      ...
      <td><button form= "1" type="submit" class="btn btn-danger" name="delete" value="Delete Cart Item">Remove</button></td>
    </tr>
  <?php endforeach; ?>
  <tr>
